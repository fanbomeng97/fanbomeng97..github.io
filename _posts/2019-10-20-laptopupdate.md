...
终于在双十一下单了内存和固态，原价133元，店家自己降价2元，双十一红包5元，最后126入手。
...
下面是用娱乐大师跑分的结果，由于内存是DDR3的低压版本，在这个年代已经没有什么竞争力了，所以评分低一点也可以理解。我用AS SSD对硬盘进行了测试，顺序读450M/s，写420M/s，整体评分1058，表现也算是中规中矩。处理器和显卡不能换，但是日常使用也绝对是够用了。
...
总的来说对于想要提升老笔记本性能的同学，可以尝试对笔记本的硬件进行升级，首推固态硬盘，对老旧机器的提升真的是太明显了。这次升级一共花了390，并且还是为了双系统买了256G的硬盘，对于普通的升级126G就足够了，感觉笔记本又可以再战3年，这么算一算性价比还是很高的。
