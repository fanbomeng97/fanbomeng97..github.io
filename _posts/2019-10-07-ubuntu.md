...
Ubuntu系统自带的LibreOffice用着有点反人类，可以下载WPS Office代替，官网下载Linux版本，直接安装。
...
Jetbrains 的 IDE 都很不错，安装方法基本上都一样，这里拿[Pycharm](https://blog.csdn.net/qq_15192373/article/details/81091278)来举例。不过要注意的是安装IntelliJ IDEA需要[配置Java环境](https://blog.csdn.net/sangewuxie/article/details/80958611)。
