...
这个就不多提了吧，个人觉得最好用的浏览器，里面的扩展程序简直不要太好用。这个可以直接从官网下载安装，非常简单。顺便提一句，国内可能不能直接访问扩展程序商店，可以到[扩展迷](https://www.extfans.com/)上下载，然后安装到Chrome上。
...
Steam是个好东西，Ubuntu也对Steam进行了支持，Ubuntu Software里就可以下载。虽然Steam平台上的有些游戏和软件不兼容Linux系统，不过有总比没有强。
